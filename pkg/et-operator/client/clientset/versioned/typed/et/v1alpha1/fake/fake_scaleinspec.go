...
var scaleinspecsResource = schema.GroupVersionResource{Group: "et", Version: "v1alpha1", Resource: "scaleinspecs"}

var scaleinspecsKind = schema.GroupVersionKind{Group: "et", Version: "v1alpha1", Kind: "ScaleInSpec"}
